...
it('can add the star name and star symbol properly', async() => {
    const starName = "STAR NOTARY SERVICE";
    const starSymbol = "SNS";
    let instance = await StarNotary.new(starName, starSymbol);

    assert.equal(await instance.name.call(), starName);
    assert.equal(await instance.symbol.call(), starSymbol);
});
